...
/obj/item/rogueweapon/sword/long/greatsword/ironclaymore
	possible_item_intents = list(/datum/intent/sword/cut, /datum/intent/sword/thrust, /datum/intent/sword/strike)
...
/obj/item/rogueweapon/sword/long/greatsword/ironclaymore/getonmobprop(tag)
	. = ..()
	if(tag)
		switch(tag)
			if("gen")
...
/obj/item/rogueweapon/sword/long/greatsword/steelclaymore
	possible_item_intents = list(/datum/intent/sword/cut, /datum/intent/sword/thrust, /datum/intent/sword/strike)
	gripped_intents = list(/datum/intent/sword/cut, /datum/intent/sword/thrust, /datum/intent/sword/strike, /datum/intent/sword/chop/long)
	force_wielded = DAMAGE_GREATSWORD_WIELD
	name = "Steel Claymore"
...
/obj/item/rogueweapon/sword/long/greatsword/steelclaymore/getonmobprop(tag)
	. = ..()
	if(tag)
		switch(tag)
			if("gen")
...
/obj/item/rogueweapon/sword/long/greatsword/gsclaymore
	possible_item_intents = list(/datum/intent/sword/cut, /datum/intent/sword/thrust, /datum/intent/sword/strike)
	gripped_intents = list(/datum/intent/sword/cut, /datum/intent/sword/thrust, /datum/intent/sword/strike, /datum/intent/sword/chop/long)
	force_wielded = DAMAGE_GREATSWORD_WIELD
...
/obj/item/rogueweapon/sword/long/greatsword/gsclaymore/getonmobprop(tag)
	. = ..()
	if(tag)
		switch(tag)
			if("gen")
